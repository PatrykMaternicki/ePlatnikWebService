package ePlatnikWebService.domain.Data.AccessSystem.User.Permision;

public class SuperAdministratorPermision implements iPermision {

	private final boolean PERMISION_TO_EMPLOYEE_UI =false;
	private final boolean PERMISION_TO_ADMINISTRATOR_UI = false;
	private final boolean PERMISION_TO_SUPERADMINISTRATOR_UI = true;
	private final boolean PERMISION_TO_DEVELOPER_UI= false;
	private final boolean PERMISION_TO_MENAGER_UI = false;
