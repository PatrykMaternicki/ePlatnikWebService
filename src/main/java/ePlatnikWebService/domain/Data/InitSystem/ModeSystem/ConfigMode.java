package ePlatnikWebService.domain.Data.InitSystem.ModeSystem;

public class ConfigMode implements iSystemMode {
	...
	private final boolean DISABLE_CONFIG_UI = false;
